...
<div class="container-fluid" style="max-width: 80%;margin-top: 5%;">
 <?php if(isset($_GET['package_id'])){
  $package_id=$_GET['package_id'];
                          // $get_data_of_all_package="SELECT * FROM package_details WHERE city_id=$package_id";
...
<div class="card" style="width: 30rem;">
  ...
  <div class="card-body">
    ...
    <a href="?package_id=<?php echo  $package_id_form_package_detail;?>" class="btn btn-danger" style="float: right;">Book Now</a>
...
?>
  <div class="card-body">
   <!--  <h5 class="card-title">Itinerary</h5> -->
     <h5 class="card-title">Day : <?php echo $itinerary_day;?></h5>
     <h5 class="card-title"><?php echo $itinerary_heading;?></h5>
    <p class="card-text"><?php echo $itinerary_desc;?></p>
     </div>
<?php }} ?>
</div>
<?php
